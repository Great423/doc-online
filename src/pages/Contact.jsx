...
const contactInfo = [
  {
    icon: Phone,
    title: "Phone",
    details: "08143652750, 08123122953",
  ...
  },
  {
    icon: MapPin,
    title: "Location",
    details: "Dinisu Clinic",
    subtext: "6 KOHWO STREET, GRA, EFFURUN, Delta State, Nigeria"
  }
];
...
const locations = [
  {
    city: "Effurun Branch",
    address: "6 KOHWO STREET, GRA, EFFURUN, Delta State, Nigeria",
    hours: "Mon-Fri: 8:00 AM - 5:00 PM",
    phone: "08143652750, 08123122953"
  }
];
    ...
    <div className="min-h-screen">
      <section className="relative px-4 py-20">
        <div className="container mx-auto text-center space-y-4">
          <Badge className="bg-primary">Contact Us</Badge>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              <Card className="relative bg-primary rounded-lg text-primary-foreground">
                <div className="absolute inset-0 z-0 rounded-lg bg-[url('/doc-online/assets/social.jpeg')] bg-cover bg-center bg-no-repeat">
                  <div className="absolute inset-0 bg-primary/80 rounded-lg"></div>
                </div>
                <CardContent className="relative p-6">
                  <div className="flex items-center justify-between">
                    <div className="space-y-2">
                      <h3 className="font-semibold text-xl">Have more questions?</h3>
                      <p>Check out our frequently asked questions</p>
                    </div>
                    <Link to="/">
                      <Button variant="primary" className="text-primary-foreground" size="lg">
                        View FAQ
                      </Button>
                    </Link>
                  </div>
