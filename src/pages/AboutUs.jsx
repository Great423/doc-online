  ...
  const doctors = [
    {
      ...
      image: "/doc-online/public/assets/dinisuceo3.jpg",
      isCEO: true
    },
    {
  ...
  return (
    <div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="relative rounded-[2rem] overflow-hidden shadow-2xl aspect-[4/5]">
                <img 
                  src="/doc-online/public/assets/doctor-patient.jpg" 
      ...
      <section className="relative py-16 bg-primary/80 text-white">
        <img src="/doc-online/public/assets/cta.jpg" className='absolute top-0 -z-20 object-cover w-full h-full' alt="cta" />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              { title: "Medical Procedures", src: '/doc-online/public/assets/doctor-patient.jpg', type: "image" },
              { title: "Lab Analysis", src: '/doc-online/public/assets/doctors-working2.webp', type: "image" },
              // { title: "Emergency Care", src: '',  type: "video" },
              { title: "Physical Therapy", src: '/doc-online/public/assets/doctors-working2.webp', type: "image" },
              ...
              <div key={index} className="relative rounded-xl overflow-hidden group">
                {item.type === "image" ?
                  ...
                  /> : 
                  <video
                    src="/doc-online/public/assets/medical-video.mp4"
                    alt={item.title}
                    className="w-full h-[300px] object-cover"
                    muted
                    controls
