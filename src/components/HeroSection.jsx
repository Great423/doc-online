...
const HeroSection = () => {
  return (
    <>
      <img src="/doc-online/public/assets/blob.webp" className="filter blur-[200px] absolute right-52 w-[500px] -z-10" alt="blob" />
      <div className="relative flex flex-col items-center justify-end px-4 lg:px-20 lg:h-[90vh] overflow-hidden">
        <div className="container mx-auto py-12 flex flex-col-reverse lg:flex-row items-center justify-between gap-8 lg:gap-0">
          ...
          <div className="flex-1">
            <motion.img
              src="/doc-online/public/assets/doctor.png"
          ...
          >
            <div className="flex items-center p-6">
              <img
                src="/doc-online/public/assets/dinisuceo1.jpg"
                alt="Avatar"
